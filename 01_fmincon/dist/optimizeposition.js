...
var wasmBinaryFile = 'optimizeposition.wasm';
...
var real__optimizeposition_initialize = asm["optimizeposition_initialize"];
asm["optimizeposition_initialize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__optimizeposition_initialize.apply(null, arguments);
};

var real__optimizeposition_terminate = asm["optimizeposition_terminate"];
asm["optimizeposition_terminate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__optimizeposition_terminate.apply(null, arguments);
};
...
var real__getPosition2Add = asm["getPosition2Add"];
asm["getPosition2Add"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getPosition2Add.apply(null, arguments);
};
...
var _optimizeposition_initialize = Module["_optimizeposition_initialize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["optimizeposition_initialize"].apply(null, arguments)
};

var _optimizeposition_terminate = Module["_optimizeposition_terminate"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["optimizeposition_terminate"].apply(null, arguments)
};
...
var _getPosition2Add = Module["_getPosition2Add"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["getPosition2Add"].apply(null, arguments)
};
